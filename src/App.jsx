...
import { TEAMS as PHOTOS, CARD_ASPECT, CTA, SOCIALS } from "./teams.js";
import { SocialBar, SocialSection, SocialIcon } from "./components/Socials.jsx";
import EXTRAS from "./extras.json"; // generated by scripts/thumbs.mjs from public/images/extras/
...
const TEAMS = PHOTOS.map((photo) => ({
  ...photo,
  extras: EXTRAS[photo.image.replace(/\.[^.]+$/, "")] ?? [],
}));
    ...
    <>
      ...
      <section className="hero" id="fotos">
        ...
        <div className="hero__actions">
          ...
          {SOCIALS.filter((s) => s.featured).map((s) => (
            <a key={s.name} className={`cta cta--${s.id}`} href={s.url} target="_blank" rel="noopener noreferrer">
